...
my $execdir = '/Users/yilu/mysql-bin/5.7/bin';
my $bindir  = '/Users/yilu/mysql-bin/5.7/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/Users/yilu/mysql-bin/5.7/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/Users/yilu/mysql-bin/5.7/include', "include/mysql", "include");
